...
export interface ApiDiscussionDiscussion extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    discussion_status: Schema.Attribute.Enumeration<['open', 'answered']>;
...
export interface ApiProductProduct extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    price: Schema.Attribute.Decimal &
      ...
      > &
      Schema.Attribute.DefaultTo<0>;
    productColor: Schema.Attribute.Component<'organisms.product-color', true>;
    publishedAt: Schema.Attribute.DateTime;
    ...
    Specifications: Schema.Attribute.Component<
      'organisms.product-specifications',
      true
    >;
...
export interface ApiReviewReview extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    parent_id: Schema.Attribute.Relation<'oneToOne', 'api::review.review'>;
    product_id: Schema.Attribute.Relation<'oneToOne', 'api::product.product'>;
    publishedAt: Schema.Attribute.DateTime;
